...
sources: ["04 - OAM 330 - Decision Making - Jan 22 2026.pptx", "Kahneman — Don't Blink (NYT)"]
confidence: high
---

## Definition
Two cognitive systems that operate **simultaneously**:
- **System 1** (limbic system / amygdala): automatic, fast, effortless, **not under conscious control**. Snap judgments, practiced routines, gut reactions, fight-or-flight. Ex: running from a wild animal, driving home the same way for years.
...
- **System 2 ≠ always-on** — it's effortful, so we conserve it; that's why biases slip through.
- **vs. computer model of cognition** — slides explicitly reject the "humans = computers running algorithms" framing. We're partly animal (reactive, emotional), partly deliberate.

...
- **Flow vs. boredom** — boredom is high skill + low challenge.
- **Flow vs. anxiety** — anxiety is low skill + high challenge.
- **Flow vs. job satisfaction** — flow is a moment-to-moment state during a task; satisfaction is a global evaluation of the job.

## Example(s)
- A coder absorbed in a hard but tractable problem, looking up to find three hours have passed.

...
## Definition
The set of workplace features that predict how satisfied employees say they are with their jobs, organized by effect size: **"Large" relationships (~.50)**, **"Medium" (>.30)**, and **"Small" (>.10)**.

## Why it matters
Slide 5 lists predictors by magnitude — directly testable. Bigger predictors of satisfaction tend to be intrinsic features of the work and immediate context (the work itself, supervision, growth) rather than headline-level extrinsics (pay).

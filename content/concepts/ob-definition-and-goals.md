...
## Definition
**Organizational behavior (OB)** is the systematic, empirical study of how individuals, groups, and structures behave inside organizations. The course's framing: "Common sense is necessary — but not sufficient — for predicting human behavior in organizations."

## Why it matters
The two payoffs of OB are tied to the [[concepts/three-course-themes]]:
1. **Predict** behavior. "In theory, a sufficiently complex model would allow us to accurately predict what you will do next."
2. **Influence** it. "If we can predict it, we can also influence it."

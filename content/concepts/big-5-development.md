...
- **vs. MBTI's origin** — MBTI built top-down from Jungian theory by Katharine Briggs and Isabel Myers, neither of whom were empirical psychologists; never replicated factor structure ([[concepts/myers-briggs]]).
- **Traits, not types** — Big 5 yields five continuous dimensions on which everyone has a score; not a categorical typology ([[concepts/ocean-traits]]).

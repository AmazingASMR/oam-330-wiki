...
## Definition
Two flavors of organizational fairness:
- **Distributive justice (what I get)** — Did I get the rewards I expected and deserved? *Outcome fairness.*
- **Procedural justice (how I get it)** — Are decisions made fairly and transparently? Did I have voice? Am I treated with dignity? Are people of my identity treated like others? *Process fairness.*
...
- **Procedural = "was the process fair?"** — process-focused. Includes voice, transparency, dignity, equal treatment across identities.
- **Equity theory** is the *mechanism* behind distributive judgments — comparison of input/output ratios. See [[concepts/equity-theory]].
- **Procedural is the bigger predictor of performance** — distributive predicts feelings about outcomes; procedural predicts behavior toward the org.

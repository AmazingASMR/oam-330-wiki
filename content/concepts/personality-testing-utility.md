...
- **Free vs. paid signal** — Williams's "buyer beware": if a test is *not* free and widely available, it is unlikely to have been rigorously validated.
- **Apparent accuracy vs. true accuracy** — Barnum-effect feedback feels personal but is generic; doesn't mean the instrument predicts behavior.

...
## Definition
The organizational antidote to widespread misconduct is a **culture of ethics**: one that builds in **transparency**, **checks and balances**, values **process (not just outcomes)**, and **encourages dissent** rather than suppressing it.

## Why it matters
Williams' takeaway (slide 21): organizations — *especially leaders* — must foster this culture, because the four enabling mechanisms (justification, norms, outcome focus, inaction) are predictable and structural. Individual ethical strategies aren't enough; the org has to be designed for ethics.

## Four ingredients (slide 21)
1. **Transparency** — no "black boxes."
2. **Checks and balances** — multiple actors must sign off; no single point of unaccountable power.
3. **Process AND outcome focus** — value *how* things get done.
4. **Dissent encouraged vs. suppressed** — speaking up is rewarded.
